...
$('.slide').slick({
  ...
  function CloseMenu(){
      let submenus=document.querySelectorAll('.sort-menu')
  ...
  CloseMenu();
    ...
    let sorttext=document.querySelectorAll('.sorttext')
    


  sorttext.forEach(txt => {
      txt.onclick=function(){
     let icon= txt.children[1]
        ...
        let element=txt.nextElementSibling;
        $(element).slideToggle();
      }
  });
